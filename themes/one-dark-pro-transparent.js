// themes/one-dark-pro-transparent.js

/** @type {import('monaco-editor').IStandaloneThemeData} */
export const oneDarkProTransparentThemeData = {
    "inherit": false,
    "base": "vs-dark",
    "colors": {
        "editor.background": "#282c3400",
        "editorGroup.background": "#181a1f00",
        "editorGroupHeader.tabsBackground": "#21252b00",
        "editorWidget.background": "#21252b00",
        "editorHoverWidget.background": "#21252b00",
        "editorSuggestWidget.background": "#21252b00",
    ...
    "rules": [
        ...
        {
            "foreground": "#c678dd",
            "token": "keyword.operator.arithmetic.c"
        },
        {
            "foreground": "#c678dd",
            "token": "keyword.operator.arithmetic.cpp"
        },
        {
            "foreground": "#e5c07b",
        ...
        {
            "foreground": "#61afef",
            "token": "support.class.math.block.environment.latex"
        },
        {
            "foreground": "#61afef",
